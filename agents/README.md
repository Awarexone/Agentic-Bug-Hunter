...
Twelve specialized AI agents, each built for exactly one job in the hunt pipeline.
...
| `recon-ranker` | Scores + ranks attack surface using hypotheses, the intelligence briefing, and lead-board chains |
...
| `autopilot` | Full autonomous hunt loop with safety checkpoints, decision-engine-driven priority scoring |
