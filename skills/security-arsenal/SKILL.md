...
> **Non-JWT encrypted session cookies / ViewState / opaque auth blobs?** If decoded length is a multiple of 8 or 16 and a 1-byte flip returns HTTP 500, test for CBC padding oracle — see web2-vuln-classes section 21 (Padding Oracle & Crypto Misuse) for PadBuster recipe and ViewState-to-RCE chain.
