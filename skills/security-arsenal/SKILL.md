...
Clickjacking on non-sensitive pages (no sensitive action in PoC) — for working overlay PoC against sensitive action, see web2-vuln-classes section 21 (CSS Injection)
Tabnabbing
...
| Clickjacking | + sensitive action + working PoC (not just login) — see web2-vuln-classes section 21 for opacity-overlay template | Medium |
